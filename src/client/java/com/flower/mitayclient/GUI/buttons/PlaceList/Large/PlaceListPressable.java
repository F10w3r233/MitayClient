...
//    private static final Identifier MOB_TOWER_RESOURCE = Identifier.of("mitayclient","textures/gui/sprites/hud/places/christmas_chest.png");
    ...
    public PlaceListPressable(int i, int j, int k, int l, Component text, String iconName, Identifier iconIdentifier, PlayerSkin skin, String type, PlayerProfile profile)
    {
        super(i, j, k, l, text);
